...
const CameraScreen = ({ navigation }) => {
    ...
    const handleDronePress = (basicDroneData) => {
        ...
        if (detailData) {
            setSelectedDrone({ ...detailData, lat: basicDroneData.lat, lon: basicDroneData.lon });
        } else {
        ...
        <View style={styles.container}>
            ...
            <View style={styles.infoContainer}>
                <View style={styles.listContainer}>
                    ...
                    {drones.map((drone) => (
                        <TouchableOpacity key={drone.id} onPress={() => handleDronePress(drone)}>
...
const styles = StyleSheet.create({
    ...
    headerText: { fontSize: 12, color: '#868686', fontWeight: '500', marginBottom: 10 },
    ...
    modalContent: { backgroundColor: 'white', borderTopLeftRadius: 20, borderTopRightRadius: 20, padding: 20, minHeight: 400, shadowColor: "#000", shadowOffset: { width: 0, height: -2 }, shadowOpacity: 0.25, shadowRadius: 4, elevation: 5 },
